...
import { OP03_EFFECTS, OP03_STATICS } from '@/data/op03/effects'
...
const registry: Record<string, EffectDef[]> = {
  ...OP01_EFFECTS,
  ...OP02_EFFECTS,
  ...OP03_EFFECTS,
  ...RULES_EFFECTS,
}
const statics: Record<string, StaticDef[]> = { ...OP01_STATICS, ...OP02_STATICS, ...OP03_STATICS }
